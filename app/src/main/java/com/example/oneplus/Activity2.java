...
public class Activity2 extends AppCompatActivity {
    ...
    TranslatorOptions options2 =
            new TranslatorOptions.Builder()
                    ...
                    .build();
    final Translator TeluguEnglishTranslator =
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtResult.setText("English to Telugu");
        txtResult2.setText("Telugu to English");
    ...
    public void setUpConditions(String text1) {
        ...
        englishGermanTranslator.translate(text1)
                .addOnSuccessListener(
    ...
    public void setUpConditions2(String text1) {
        // Create an English-German translator:
        TeluguEnglishTranslator.translate(text1)
                .addOnSuccessListener(
                        (OnSuccessListener) translatedText ->{
                            txtResult2.setText("");
